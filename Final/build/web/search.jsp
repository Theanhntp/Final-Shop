...
<div class="header-with-search">
    <div class="header__logo">
        <a href="loadpage" class="header__logo-link">
        ...
        <div class="header__search-input-wrap">
            ...
            <div class="header__search-history">
                ...
                <ul class="header__search-history-list">
                    ...
                    <c:forEach var="cookieItem" items="${cookies}">
                        <c:if test="${cookieItem.name == 'searchhistory'}">
                            <c:forEach var="value" items="${cookieItem.value.split('/')}">
                                <li class="header__search-history-item">
                                    <a href="filterproduct?action=search&searchcontent=${value}">${value}</a>
                                </li>
                            </c:forEach>
                        </c:if>
                    </c:forEach>
